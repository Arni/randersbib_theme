...
<article class="eresource">
  ...
  <div class="eresource-content">
    ...
    <?php
      ...
      hide($content['field_ding_eresource_info']);
      hide($content['field_ding_eresource_list_image']);
    ...
    <?php if (isset($content['field_ding_eresource_info'])) : ?>
      <?php print render($content['field_ding_eresource_info']); ?>
    <?php endif; ?>
  </div>
